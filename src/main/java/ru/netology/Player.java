...
public class Player {
    ...
    public int play(Game game, int hours) {
        ...
        if (playedTime.containsKey(game)) {
            playedTime.put(game, playedTime.get(game) + hours);  // добавлено hours
        } else {
            throw new RuntimeException("Игра " + game + " не установлена"); // добавлено RuntimeException
        }
